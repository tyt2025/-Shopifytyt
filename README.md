...
Dashboard para gestionar y publicar productos de Supabase a Shopify con mapeo de categorías personalizado **basado en tus categorías reales de Shopify**.

## 🚀 Características

- ✅ Vista completa de productos de Supabase
- ✅ **Categorías REALES extraídas de tu Shopify** (18 categorías)
- ✅ Subcategorías (tags) que se filtran automáticamente
- ✅ Menús desplegables para selección rápida
- ✅ Publicación masiva o individual de productos
- ✅ Búsqueda y filtrado por categorías
- ✅ Gestión de estado de publicación
- ✅ Vista previa de cómo se verá en Shopify
- ✅ Interfaz moderna con Tailwind CSS
- ✅ 100% compatible con GitHub y Vercel

## 📋 Categorías Disponibles

El dashboard incluye **tus categorías reales de Shopify**:
...
Cada categoría tiene sus propias subcategorías (tags) específicas.
