...
export default function Dashboard() {
  ...
  const [tipo, setTipo] = useState('Electrónica'); // Valor por defecto
          ...
          <div className="space-y-6">
            ...
            <div className="bg-white rounded-lg shadow-md p-6 space-y-4">
              ...
              <div>
                ...
                />
                <p className="text-xs text-gray-500 mt-1">Por defecto: Electrónica. Puedes cambiarlo según el producto</p>
              </div>
              ...
              <div className="bg-gray-50 border border-gray-200 rounded-lg p-4 space-y-2">
                ...
                <ul className="text-xs text-gray-600 space-y-1 list-disc list-inside">
                  ...
                  <li>Inventario: Con seguimiento desde Supabase</li>
                  <li>Publicación: Activo en Google y YouTube</li>
                  <li>Estado: Activo y publicado</li>
                </ul>
              </div>
