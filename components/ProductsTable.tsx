...
export default function ProductsTable({ initialProducts }: ProductsTableProps) {
  ...
  const handlePublishSelected = async () => {
    ...
    setPublishing(true);
    try {
      // Aquí implementarías la lógica de publicación a Shopify
      // Por ahora, solo actualizamos en Supabase
              ...
              {products.map((product) => {
                ...
                return (
                  <tr key={product.id} className="hover:bg-gray-50">
                    ...
                    <td className="px-4 py-3 text-sm">{product.marca}</td>
                      ...
                      <div className="relative">
                        <details className="cursor-pointer">
                          <summary className="text-sm text-blue-600 hover:text-blue-800">
                            {product.colecciones?.length || 0} seleccionadas
                          </summary>
